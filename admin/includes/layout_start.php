                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="<?= e(route_url('admin', 'dashboard')) ?>"
                                class="nav-link <?= $adminActive === 'dashboard' ? 'active' : '' ?>">
                                <i class="nav-icon fas fa-tachometer-alt"></i>
                                <p>Dashboard</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= e(route_url('admin', 'products')) ?>"
                                class="nav-link <?= $adminActive === 'products' ? 'active' : '' ?>">
                                <i class="nav-icon fas fa-th"></i>
                                <p>Quản lý sản phẩm</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= e(route_url('admin', 'accounts')) ?>"
                                class="nav-link <?= $adminActive === 'accounts' ? 'active' : '' ?>">
                                <i class="nav-icon fas fa-users"></i>
                                <p>Quản lý tài khoản</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= e(route_url('admin', 'orders')) ?>"
                                class="nav-link <?= $adminActive === 'orders' ? 'active' : '' ?>">
                                <i class="nav-icon fas fa-shopping-cart"></i>
                                <p>Đơn hàng</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= e(route_url('admin', 'categories')) ?>"
                                class="nav-link <?= $adminActive === 'categories' ? 'active' : '' ?>">
                                <i class="nav-icon fas fa-tags"></i>
                                <p>Danh mục</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= e(route_url('admin', 'chat')) ?>"
                                class="nav-link <?= $adminActive === 'chat' ? 'active' : '' ?>">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            ...
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <?php if (!empty($bc['url'])): ?>
                                <li class="breadcrumb-item"><a href="<?= e($bc['url']) ?>"><?= e($bc['label']) ?></a>
                                </li>
                                <?php else: ?>
